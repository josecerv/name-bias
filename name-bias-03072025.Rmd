...
p1 <- ggplot(plot_data, aes(x = Region, y = freq * 100, fill = Feedback)) +
  ...
  geom_text(aes(label = sprintf("%.1f%%", freq * 100)),
            position = position_dodge(width = 0.9),
            vjust = 3.5, # Place text inside the bars
            color = "white",
            size = 6,
            fontface = "bold") +
  ...
  # Level 1: Brackets and deltas for within-group comparisons
  annotate("segment", x = 0.75, xend = 1.25, y = 15, yend = 15) +
  annotate("text", x = 1, y = 16.5, label = "n.s.", size = 4.5) +
  annotate("text", x = 1, y = 19, label = sprintf("Δ = %.1f%%", delta_eastern_val), size = 6.5, fontface = "italic") +
  
  annotate("segment", x = 1.75, xend = 2.25, y = 25, yend = 25) +
  annotate("text", x = 2, y = 26.5, label = "***", size = 5.5) +
  annotate("text", x = 2, y = 29, label = sprintf("Δ = %.1f%%", delta_western_val), size = 6.5, fontface = "italic") +

  # Level 2: Overarching bracket for the interaction test
  annotate("segment", x = 1, xend = 2, y = 35, yend = 35) +
  annotate("segment", x = 1, xend = 1, y = 34, yend = 35) + # Left vertical line
  annotate("segment", x = 2, xend = 2, y = 34, yend = 35) + # Right vertical line
  annotate("text", x = 1.5, y = 36.5, 
           label = expression(paste("Difference in ", Delta, "s: ", chi^2, "(1) = 4.40, ", italic("p"), " = 0.036")), 
           size = 6.5) +
